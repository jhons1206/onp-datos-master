...
const routes: Routes = [
  ...
  { path: 'Facil', loadChildren:()=>import('./pages/facil/facil.module').then(m=>m.FacilModule)},
  //{ path: 'Facil/:id', component: FacilComponent,canActivate: []},
  { path: 'Facil/:id', loadChildren:()=>import('./pages/facil/facil.module').then(m=>m.FacilModule)},
