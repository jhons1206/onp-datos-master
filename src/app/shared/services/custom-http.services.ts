...
export class CustomHttpService {
   ...
   get(url: string, mapper: (value: any, index: number) => any): Observable<any> {
  ...
  getValue(url: string) {
   ...
   /* put(url: string, body: any, mapper): Observable<any> {
   ...
   /* postMap(url: string, body: any, mapper): Observable<any> {
    ...
    public getHeaders(): HttpHeaders {
        ...
        //header = header.append('Content-Type', 'application/json').append('Authorization', 'Bearer ' + localStorage.getItem('token'));
        return header;
  }
